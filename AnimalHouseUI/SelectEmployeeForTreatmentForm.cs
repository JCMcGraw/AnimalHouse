...
{
    public partial class SelectEmployeeForTreatmentForm : Form
    {
        List<Employee> employees;
        public Employee selectedEmployee { get; private set; }
        public SelectEmployeeForTreatmentForm(List<Employee> employees)
        {
            InitializeComponent();
            this.employees = employees;

            SelectVetCombobox.DataSource = employees;
            SelectVetCombobox.DisplayMember = "name";

            if (employees.Count == 0)
            {
                InfoLabel.Text = "Der er ingen dyrlæger fri i det valgte tidsrum";
        ...
        private void SelectButton_Click(object sender, EventArgs e)
        {
            ...
            selectedEmployee = (Employee)SelectVetCombobox.SelectedItem;
            this.Close();
        }

...
namespace AnimalHouseUI
{
    public partial class TreatmentBooking : Form
    {
        ...
        private void CalendarBooking_ItemCreating(object sender, CalendarItemCancelEventArgs e)
        {
            ...
            {
                Treatment treatment = TreatmentFactory.Instance().CreateTreatment((int)ComboBoxTreatmentType.SelectedValue, -1, -1, -1, e.Item.StartDate, e.Item.EndDate, false, "", true, -1, -1);
        ...
        private void ButtonCreateTreatment_Click(object sender, EventArgs e)
        {
            ...
            if (dialogResult == DialogResult.Yes)
            {
                Treatment treatment = TreatmentFactory.Instance().CreateTreatment((int)ComboBoxTreatmentType.SelectedValue, -1, -1, -1, selectionStart, selectionEnd, false, "", true, -1, -1);
                Treatment treatmentWithID = bossController.treatmentController.CreateTreatment(treatment);

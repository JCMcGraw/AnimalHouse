...
namespace AnimalHouseUnitTest
{
    ...
    public class TreatmentUnitTest
    {
        ...
        {
            Treatment treatment = new Treatment(treatmentType, null, null, item, DateTime.Now, DateTime.Now, true, "", true, null, employee);
        ...
        {
            Treatment treatment = new Treatment(treatmentID,treatmentType, null, null, item, DateTime.Now, DateTime.Now, true, "", true,null, employee);
